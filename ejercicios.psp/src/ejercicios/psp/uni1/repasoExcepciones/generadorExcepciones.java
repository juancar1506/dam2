        ...
        switch (intento) {
            case 1:
                try {
                    ...
                    // e.printStackTrace();
                    System.out.println("Se controla la excepcion ArithmeticException en la llamada "+ (i+1));
                }
            ...
            case 2:
                try {
                    ...
                    // e.printStackTrace();
                    System.out.println("Se controla la excepcion NegativeArraySizeException en la llamada "+ (i+1));
                }
                System.out.println("El programa no ha explotado gracias al manejo de excepciones");
                break;
            case 3:
                try {
                    ...
                    // e.printStackTrace();
                    System.out.println("Se controla la excepcion NullPointerException en la llamada "+ (i+1));
                }
                System.out.println("El programa no ha explotado gracias al manejo de excepciones");
                break;
                case 4:
                try {
                    ...
                    // e.printStackTrace();
                    System.out.println("Se controla la excepcion IndexOutOfBoundsException en la llamada "+ (i+1));
                }
                System.out.println("El programa no ha explotado gracias al manejo de excepciones");
            break;                     
            default:
